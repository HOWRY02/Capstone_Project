...
function adjustInputElementsSize() {
    ...
    const button_class = document.querySelectorAll('#homeButton, #extractButton, #showButton, #submitButton, #questionButton, #answerButton, #titleButton, #dateButton, #tableButton');
